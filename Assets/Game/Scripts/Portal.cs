...
public class Portal : MonoBehaviour
{
    ...
    [SerializeField] private Rigidbody cubeyRigidBody;
    ...
    private void Awake()
    {
        ...
        { 
            ...
            visualEffects = FindFirstObjectByType<VisualEffects>();
        }
    }
    ...
    private void HitPortal(Collider other)
    {
        ...
        {
            if (cubeyRigidBody == null)
            {
                cubeyRigidBody = other.GetComponent<Rigidbody>();
            }

            cubeyMagnitude = cubeyRigidBody.velocity.magnitude;
    ...
    private void TeleportObject()
    {
        ...
        cubeyRigidBody.isKinematic = true;
    ...
    private IEnumerator DelayTeleport(LeanForceRigidbodyCustom leanForce)
    {
        ...
        cubeyRigidBody.isKinematic = false;
        ...
        if (cubeyRigidBody != null)
        {
            if (leanForce != null) // in game
            {
                ...
                cubeyRigidBody.AddForce(portalExit.transform.up * cubeyForce, ForceMode.Impulse); // 6
            }
            else // main menu
            {
                cubeyRigidBody.AddForce(portalExit.transform.up * portalForceMultiply, ForceMode.Impulse);
            }
        }
