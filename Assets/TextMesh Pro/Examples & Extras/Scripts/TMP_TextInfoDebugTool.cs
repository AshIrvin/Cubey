            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Logger.Instance.ShowDebugLog("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Logger.Instance.ShowDebugLog("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Logger.Instance.ShowDebugLog(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
