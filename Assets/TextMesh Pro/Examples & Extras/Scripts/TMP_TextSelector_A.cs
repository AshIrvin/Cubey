    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //Logger.Instance.ShowDebugLog("[" + m_TextMeshPro.textInfo.characterInfo[charIndex].character + "] has been selected.");
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    //Logger.Instance.ShowDebugLog("Mouse Position: " + Input.mousePosition.ToString("f3") + "  Word Position: " + wordPOS.ToString("f3"));
